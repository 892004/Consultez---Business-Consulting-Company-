...
const Testimonials = () => {
  ...
  return (
    <section className="Testimonials relative min-h-screen w-full bg-[#1A4137] -translate-y-70 overflow-hidden rounded-[40%_40%_0_0_/_50px_50px_0_0] flex flex-row items-center justify-center">
