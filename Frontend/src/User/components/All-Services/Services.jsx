...
const serviceCards = [
  ...
  return (
    <section ref={ref} className="services relative h-[130vh] w-full mt-30 flex flex-row">

        <div className="left h-full w-[60%] relative">
            <button className='py-2 px-10 rounded-full bg-[#C6D936] mx-35 my-30 absolute font-semibold tracking-widest text-sm'>SERVICE AREA</button>
            <h2 className='mx-35 my-42 absolute text-5xl font-bold leading-16'>Empowering Your Brand <br/>Innovative Solution</h2>
          ...
          <div className="absolute h-150 w-320 top-80 left-30 right-50 bottom-50 z-30 p-5">
    ...
    {serviceCards.map((item) => (
      <SwiperSlide key={item.id}>
        ...
        <div className="right h-full w-[40%] bg-[#1A4137] p-10 relative">
            <button className='py-4 px-14 font-medium bg-[#C6D936] mx-35 my-30 absolute'>All Services</button>
            <img src={serviceLine} className='absolute right-0 animate-slideUpDown' />
